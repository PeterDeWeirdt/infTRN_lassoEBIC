%% example_workflow_Th17_EBIC_MTL
% Use MTL-EBIC to build multiple TRNs from gene expression and prior
...
% (2) Zhou, Chen, Ye (2011) "MALSAR: Multi-task learning via structural
% regularization." http://jiayuzhou.github.io/MALSAR/
