function TRNebic(geneExprMat,tfaMat,lambdaBias,tfaOpt,...
...
%    nboots,minFrac,lambdaMin,lambdaMax,totLogLambdaSteps,...
%    trnOutMat,leaveOutSampleList)
%% Goal: Rank gene-TF interactions using EBIC to select the optimal tuning parameter(s) 
% for given input prior, prior reinforcement, TFA methods. 
%% References:
...
% minFrac -- Minimum fraction of bootstraps that an edge must be in to be included 
...
% trnOutMat -- full file name and path for output .mat file, will also
%   be used as file base name for figures and .mat output from EBIC
%   parameter search
